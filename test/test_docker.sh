...
echo "Starting Nextflow... Command:"
echo "nextflow run . -profile docker --test --step skipPreprocessing --tools HaplotypeCaller,MuTect1,MuTect2,Strelka"
echo "-----"
nextflow run . -profile docker --test --step skipPreprocessing --tools HaplotypeCaller,MuTect1,MuTect2,Strelka
