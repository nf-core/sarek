...
# vcfsamplediff -s VT normal tumour freebayesresult.vcf |egrep "#|somatic|loh" | vcffilter -f "QUAL > 20" | vcfflatten| awk -f ~/CAW/scripts/speedseq.filter.awk -v NORMAL_IDX=10 -v TUMOUR_IDX=11 > filtered.vcf
