...
nextflow run ${CAW}/main.nf --step skipPreprocessing -profile singularityLocal --tools $2 --sample $1 -with-timeline ${PREFIX}.timeline.html -with-trace -with-trace ${PREFIX}.trace.txt
