...
- [#2257](https://github.com/nf-core/sarek/pull/2257) - Fail early when `--tools parabricks_haplotypecaller` is combined with `--joint_germline` instead of finishing without producing any variants. Joint genotyping is not wired up for this caller yet
