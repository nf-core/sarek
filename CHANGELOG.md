...
- [#2142](https://github.com/nf-core/sarek/pull/2142) - Fix cloud test to use secrets instead of vars for TOWER_BUCKET_AWS, TOWER_COMPUTE_ENV, and TOWER_WORKSPACE_ID
