...
- [#7](https://github.com/nf-core/sarek/pull/7) - Run the somatic test as default on `-profile test_full`, the germline can be tested with `-profile test_full_somatic`
