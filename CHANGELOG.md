...
- [#2241](https://github.com/nf-core/sarek/pull/2241) - Migrate `samtools/*` modules to the versions topic channel
- [#2242](https://github.com/nf-core/sarek/pull/2242) - Migrate QC/coverage modules (`fastqc`, `mosdepth`, `ngscheckmate`, `goleft`, `msisensor2`, `msisensorpro`, `ascat`) to the versions topic channel
