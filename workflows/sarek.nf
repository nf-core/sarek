...
include { SAMTOOLS_CONVERT as BAMTOCRAM_INPUT            } from '../modules/nf-core/samtools/convert/main'
include { SAMTOOLS_CONVERT as BAMTOCRAM_MAPPING          } from '../modules/nf-core/samtools/convert/main'
