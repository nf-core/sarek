...
include { SAMTOOLS_CONVERT as CRAM_TO_BAM_RECAL             } from '../../modules/nf-core/samtools/convert'
...
workflow SAREK {
    ...
    if (params.step in ['mapping', 'markduplicates']) {
        ...
        ch_md_cram_for_restart = Channel
            .empty()
    ...
    if (params.step in ['mapping', 'markduplicates', 'prepare_recalibration']) {
        ...
        if (params.step == 'prepare_recalibration') {
            ...
            ch_cram_for_bam_baserecalibrator = Channel
                .empty()
...
def addReadgroupToMeta(meta, files) {
    ...
    def read_group = "\"@RG\\tID:${sample_lane_id}\\t${CN}PU:${meta.lane}\\tSM:${meta.patient}_${meta.sample}\\tLB:${meta.sample}\\tDS:FASTA\\tPL:${params.seq_platform}\""
