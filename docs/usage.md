...
| dbsnp                 | Baserecalibrator, HaplotypeCaller, GenotypeGVCF, ControlFREEC                                                                                                                                                                                                                                                                                                                                                                                                       | possibly from an old ftp server dbsnp_146.hg38.vcf.gz                                                                                                                                   | https://gatk.broadinstitute.org/hc/en-us/articles/360035890811-Resource-bundle       |
| dbsnp_tbi             | Baserecalibrator(Spark), HaplotypeCaller, GenotypeGVCF ControlFREEC                                                                                                                                                                                                                                                                                                                                                                                                 |                                                                                                                                                                                         |                                                                                      |
...
| fasta                 | ASCAT, interval building, BWa/BWAMem2/DragMap index creation, CNVKit, DEEPVariant, EnsemblVEP, snpEff ControlFREEC, FreeBayes, Manta, Samtools, MSISensorPro, Baserecalibrator(Spark), ApplyBQSR(Spark), CNNScoreVariant, EstimateLibraryComplexity, FilterMutectCalls, FilterVariantTranches, GatherPileupSummaries,GenotypeGVCF, GetPileupSummaries, HaplotypeCaller, MarkDulpicates(Spark), MergeVCFs, Mutect2, Variantrecalibrator, ApplyVQSR, Strelka, Tiddit, | https://console.cloud.google.com/storage/browser/_details/genomics-public-data/resources/broad/hg38/v0/Homo_sapiens_assembly38.fasta                                                    | https://gatk.broadinstitute.org/hc/en-us/articles/360035890811-Resource-bundle       |
| fasta_fai             | ASCAT, interval building, BWA/BWAMem2/DragMap index creation, CNVKit, DEEPVariant, EnsemblVEP, snpEff ControlFREEC, FreeBayes, Manta, Samtools, MSISensorPro, Baserecalibrator(Spark), ApplyBQSR(Spark), CNNScoreVariant, EstimateLibraryComplexity, FilterMutectCalls, FilterVariantTranches, GatherPileupSummaries,GenotypeGVCF, GetPileupSummaries, HaplotypeCaller, MarkDulpicates(Spark), MergeVCFs, Mutect2, Variantrecalibrator, ApplyVQSR, Strelka, Tiddit, | https://console.cloud.google.com/storage/browser/_details/genomics-public-data/resources/broad/hg38/v0/Homo_sapiens_assembly38.fasta.fai                                                | https://gatk.broadinstitute.org/hc/en-us/articles/360035890811-Resource-bundle       |
| germline_resource     | Mutect2, GetPileupsummaries,                                                                                                                                                                                                                                                                                                                                                                                                                                        | ? gnomAD.r2.1.1.GRCh38.PASS.AC.AF.only.vcf.gz"                                                                                                                                          |                                                                                      |
| germline_resource_tbi |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | ? gnomAD.r2.1.1.GRCh38.PASS.AC.AF.only.vcf.gz.tbi"                                                                                                                                      |                                                                                      |
| intervals             | Baserecalibraotr(Spark), ApplyBQSR(Spark), Deepvariant, FreeBayes, Strelka, HaplotypeCaller, CNNScoreVariants,FilterVariantTranches,GenotypeGVCF, mpileup, mutect2, GetPileupSummaries, MSISensorPro, ASCAT, ControlFREEC, BCFTools, VCFTools                                                                                                                                                                                                                       | https://console.cloud.google.com/storage/browser/_details/genomics-public-data/resources/broad/hg38/v0/wgs_calling_regions.hg38.interval_list                                           |                                                                                      |
