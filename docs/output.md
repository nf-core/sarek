...
- [Variant Calling](#variant-calling)
  ...
  - [Sample heterogeneity, ploidy and CNVs](#sample-heterogeneity-ploidy-and-cnvs)
    ...
    - [ASCAT](#ascat)
      - [BAF and LogR values](#baf-and-logr-values)
      - [Loci file](#loci-file)
      - [GC correction file](#gc-correction-file)
        - [scripts and data for generating the GC correction file](#scripts-and-data-for-generating-the-gc-correction-file)
        - [Modification of createWindowBed.pl for our GRCh37 loci file](#modification-of-createwindowbedpl-for-our-grch37-loci-file)
        - [Process](#process)
        - [Format of GC correction file](#format-of-gc-correction-file)
      - [Output](#output)
...
The genome reference file we use in Sarek for GRCh37 is coded without "chr" in the chromosome names, while the genome reference file we use in Sarek for GRCh38 includes "chr" in the chromosome names.
