...
If `--mutect2_force_call` is used, all alleles in the supplied vcf are force-called in addition to any other variants Mutect2 discovers, and emitted in the output vcf regardless of their evidence. For further reading see the [Mutect2 tool index](https://gatk.broadinstitute.org/hc/en-us/articles/360037593851-Mutect2).
