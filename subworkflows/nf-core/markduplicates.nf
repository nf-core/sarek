...
include { SAMTOOLS_VIEW as SAMTOOLS_BAM_TO_CRAM }       from '../../modules/nf-core/modules/samtools/view/main'         addParams(options: params.samtools_view_options)
include { SAMTOOLS_VIEW as SAMTOOLS_BAM_TO_CRAM_SPARK } from '../../modules/nf-core/modules/samtools/view/main'         addParams(options: params.samtools_view_options)
    ...
    if (skip_markduplicates) {
        ...
        if (use_gatk_spark) {
            ...
            if (!skip_bamqc) {
                ...
                SAMTOOLS_BAM_TO_CRAM_SPARK(bam_markduplicates, fasta)
