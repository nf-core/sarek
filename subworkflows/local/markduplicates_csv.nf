...
workflow MARKDUPLICATES_CSV {
    ...
    main:
        ...
        cram_markduplicates.collectFile(storeDir: "${params.outdir}/csv") { meta, cram, crai ->
        ...
        }.collectFile(name: 'markduplicates_no_table.csv', keepHeader: true, skip: 1, sort: true, storeDir: "${params.outdir}/csv")
}
