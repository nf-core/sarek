workflow  SAMPLESHEET_TO_CHANNEL{
    ...
    if (step == 'mapping' && aligner.contains("parabricks") && umi_read_structure) {
        error("Parabricks fq2bam is currently not compatible with FGBio UMI handeling. Please choose a different aligner.")
    }
