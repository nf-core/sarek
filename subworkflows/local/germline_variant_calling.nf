...
include { GATK4_HAPLOTYPECALLER as HAPLOTYPECALLER } from '../../modules/nf-core/modules/gatk4/haplotypecaller/main'      addParams(options: params.haplotypecaller_options)
include { DEEPVARIANT }                              from '../../modules/local/deepvariant/main'                addParams(options: params.deepvariant_options)
include { GATK4_GENOTYPEGVCFS as GENOTYPEGVCF }       from '../../modules/nf-core/modules/gatk4/genotypegvcfs/main'         addParams(options: params.genotypegvcf_options)
