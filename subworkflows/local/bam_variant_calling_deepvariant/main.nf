...
include { DEEPVARIANT_RUNDEEPVARIANT                } from '../../../modules/nf-core/deepvariant/deepvariant_rundeepvariant/main'
...
workflow BAM_VARIANT_CALLING_DEEPVARIANT {
    ...
    DEEPVARIANT_RUNDEEPVARIANT(cram_intervals, fasta, fasta_fai, [ [ id:'null' ], [] ])
