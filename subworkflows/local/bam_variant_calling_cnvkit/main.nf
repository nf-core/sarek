...
include { CNVKIT_CALL        } from '../../../modules/nf-core/cnvkit/call'
include { CNVKIT_EXPORT      } from '../../../modules/nf-core/cnvkit/export'
include { CNVKIT_GENEMETRICS } from '../../../modules/nf-core/cnvkit/genemetrics'
