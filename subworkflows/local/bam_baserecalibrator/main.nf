...
workflow BAM_BASERECALIBRATOR {
    ...
    GATK4_BASERECALIBRATOR(cram_intervals, fasta.map{ meta, fasta_ -> [ fasta_ ] }, fasta_fai.map{ meta, fasta_fai_ -> [ fasta_fai_ ] }, dict.map{ meta, dict_ -> [ dict_ ] }, known_sites, known_sites_tbi)
