...
workflow FASTQ_ALIGN_BWAMEM_MEM2_DRAGMAP_SENTIEON {
    ...
    NARFMAP_ALIGN(reads, index.map{ it -> [ [ id:'index' ], it ] }, sort) // If aligner is dragmap
    ...
    bam = bam.mix(NARFMAP_ALIGN.out.bam)
