...
workflow BAM_VARIANT_CALLING_TUMOR_ONLY_MUTECT2 {
    ...
    if (joint_mutect2) {
        ...
        MUTECT2(input_joint_intervals, fasta, fai, dict, germline_resource, germline_resource_tbi, panel_of_normals, panel_of_normals_tbi, mutect2_force_alleles, mutect2_force_alleles_tbi)
    }
    else {
        // Perform variant calling using mutect2 module in tumor single mode
        MUTECT2(input_intervals, fasta, fai, dict, germline_resource, germline_resource_tbi, panel_of_normals, panel_of_normals_tbi, mutect2_force_alleles, mutect2_force_alleles_tbi)
    }
