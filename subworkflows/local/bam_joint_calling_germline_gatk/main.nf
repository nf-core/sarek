...
include { GATK4_APPLYVQSR as GATK4_APPLYVQSR_INDEL               } from '../../../modules/nf-core/gatk4/applyvqsr'
...
workflow BAM_JOINT_CALLING_GERMLINE_GATK {
    ...
    vqsr_input_snp = vqsr_input
        .join(VARIANTRECALIBRATOR_SNP.out.recal, failOnDuplicate: true)
    ...
    // Rework meta for variantscalled.csv and annotation tools
    vqsr_input_indel = GATK4_APPLYVQSR_SNP.out.vcf
    ...
    genotype_vcf = merge_vcf_for_join
    ...
    genotype_index = merge_tbi_for_join
    ...
    versions = versions.mix(GATK4_APPLYVQSR_INDEL.out.versions)
